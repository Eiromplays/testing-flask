...
- 🎯 Entry points to execute your program using `python -m <testing_flask>` or `$ testing_flask` with basic CLI argument parsing.
...
---
# testing_flask Flask Application

Awesome testing_flask created by Eiromplays
...
```bash
git clone https://github.com/Eiromplays/testing-flask testing_flask
cd testing_flask
make install
```
...
```bash
testing_flask create-db   # run once
testing_flask populate-db  # run once (optional)
testing_flask add-user -u admin -p 1234  # ads a user
testing_flask run
```
